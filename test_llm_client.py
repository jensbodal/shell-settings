...
class TestLLMClient(unittest.TestCase):
    ...
    def test_model_mapping(self):
        ...
        self.assertEqual(self.client.get_openrouter_model("llama3"), "anthropic/claude-3-opus:beta")
        self.assertEqual(self.client.get_openrouter_model("unknown_model"), "anthropic/claude-3-sonnet:beta")
    ...
    def test_generate_with_ollama(self, mock_generate_ollama, mock_is_available):
        ...
        mock_generate_ollama.return_value = {"text": "Test response", "model": "llama3", "provider": "ollama"}
    ...
    def test_generate_with_fallback(self, mock_generate_openrouter, mock_is_available):
        ...
        mock_generate_openrouter.return_value = {"text": "Fallback response", "model": "anthropic/claude-3-opus:beta", "provider": "openrouter"}
